...
public class Home_admin_adapter extends RecyclerView.Adapter<Home_admin_adapter.MyViewHolder> {
    ...
    public Home_admin_adapter(Context context, List<Home_user_bean> item_list) {
    ...
    @Override
    public void onBindViewHolder(Home_admin_adapter.MyViewHolder holder, int position) {
